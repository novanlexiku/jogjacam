                        ...
                        <div class="mt-1">
                            ...
                            ?>
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <span class="alert-icon"><i class="ni ni-like-2"></i></span>
                                    <span class="alert-text"><strong>Sukses!</strong> Batalkan Data Pemesanan!</span>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                            ...
                            ?>
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <span class="alert-icon"><i class="ni ni-like-2"></i></span>
                                    <span class="alert-text"><strong>Sukses!</strong> Upload Bukti Pembayaran!</span>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                            ...
                            ?>
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <span class="alert-icon"><i class="ni ni-like-2"></i></span>
                                    <span class="alert-text"><strong>Peringatan!</strong> Gambar gagal di upload!</span>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                    ...
                                    <td style="text-align:center;">
                                        <?php if ($this->session->userdata('user_level') == '1' || $this->session->userdata('user_level') == '2') { ?>
                                            <form class="form-horizontal" method="post" action="<?php echo base_url() . 'index.php/admin/pengiriman/detail' ?>">
                                                ...
                                                <a class="btn btn-sm btn-danger" href="#modalBatalkan<?php echo $id ?>" data-toggle="modal" title="Batalkan"><span class="fa fa-close"></span> Batalkan</a>
                                            <?php } else { ?>
                                                ...
                                                <a class="btn btn-sm btn-danger disabled" href="#modalBatalkan<?php echo $id ?>" data-toggle="modal" title="Batalkan"><span class="fa fa-close"></span> Batalkan</a>
                                            <?php } ?>
...
foreach ($data->result_array() as $a) {
    ...
    $sts = $a['invoice_status'];
?>
    <div id="modalBatalkan<?php echo $id ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel">Batalkan Pemesanan</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url() . 'index.php/admin/pemesanan/update' ?>">
                    <div class="modal-body">
                        ...
                        <input name="invoice_id" type="hidden" value="<?php echo $id; ?>">
                        <input name="invoice_status" type="hidden" value="gagal">
